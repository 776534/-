...
const Contactus = () => {
    ...
    <div className="Location-container">
      <div className="Location-container-word">
        <h1>umai實體料理教室</h1>
        <p>地址:<br />台北市中山區新生北路二段29之一號</p>
        <p>連絡電話:<br />+886 225373239</p>
        <p>營業時間:<br />詳見各課程上課日期及時段</p>
      </div>
    ...
    <div className="Detail">
      <h1 style={{top:"-17px"}}>取得聯繫</h1>
      <p>
        如果您對umai報名課程或開設課程有任何問題<br />歡迎留言給我們,專人將會主動與您聯繫
      </p>
      ...
      <p>
      <input type="submit" value="送出" className="Form-btn" onClick={success}/>
      </p>
